...
function gangstaTems () {
	playerHt.value = '';
	mainArr = ['Хата Вадика','Гимназия','5 парсека','Откидон','Гей клуб','Макдональс','МНВК','Житомир','Свечка','Поезд','Вейпшоп','Зона','Донбас','Бар','Казино','Варус','ПТУ','Кабинет Костивской','Гроб','Ликеро-водочный завод','Столовка в школе','Психобольница','Наркопритон','Пентагон','Запой','Железка', 'Последняя парта','Лес' ,'Птицеферма' ,'Марс']
